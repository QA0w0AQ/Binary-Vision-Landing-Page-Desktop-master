...
export class MainComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        document.getElementById('main-header-right').addEventListener('animationend', () => {
            document.getElementById('main-header-bottom').style.display = 'block';
            document.getElementById('main-header-bottom').className = 'main-header-bottom animated fadeInUp fast';
        });

        document.getElementById('main-header-bottom').addEventListener('animationend', () => {
    ...
    // moveBackground();
        ...
        if (top > clientsList) {
            ...
            if (top > skillsSection) {
                ...
                if (document.getElementsByClassName('skills-letter').length === 42) {
                    ...
                    for (let i = 0; i < 42; i++) {
                        if (letters.length !== 0) {
                            setTimeout(() => {
                                ...
                                // document.getElementById('skills-letter-' + i).classList.add('animated');
